...
public class MenuKruLihatData extends javax.swing.JFrame {
    ...
    if (selectedRow != -1) {
        ...
        if (newKontak != null && newDomisili != null && newUsername != null && newPassword != null) {
            try {
                boolean isUpdated = RequestController.updateUserData(currentUsername, newUsername, newPassword, newKontak, newDomisili);
                if (isUpdated) {
...
//        // TODO add your handling code here:
    ...
    if (selectedRow != -1) {
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            try {
                boolean isDeleted = RequestController.deleteUser(username);
                if (isDeleted) {
